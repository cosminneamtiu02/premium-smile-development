...
// Pages/Services — the INTERIM STUB as it actually ships: one heading reusing
// the nav label, no new message keys. The real ServicesIntro · ServiceCard list
// · price rows · CTABanner arrive with the §14 Services lane, and the owner
// authors that content (§15.17).
//
// KEEP-IN-SYNC with src/app/[locale]/services/page.tsx: that page is an async
...
/** KEEP-IN-SYNC twin of src/app/[locale]/services/page.tsx. */
