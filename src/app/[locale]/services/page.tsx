...
// rows · CTABanner). It exists so the shell's live nav has a resolvable
...
// KEEP-IN-SYNC with ./Services.stories.tsx: this file is an async Server
// Component and cannot render in the browser runner, so the story twins its
// markup through `useTranslations` and pins it (owner, 2026-09-06).
