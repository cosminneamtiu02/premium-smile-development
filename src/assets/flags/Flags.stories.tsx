...
function PreviewDisc({
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="absolute inset-0 rounded-full bg-ink/5 transition-[background-color] duration-[400ms] ease-in-out group-hover:bg-ink/10 motion-reduce:transition-none"
      />
      <span
  ...
  render: () => (
    <div className="flex flex-col gap-6">
      ...
      <p className="max-w-prose text-sm text-ink-muted">
        ...
        <code>group-hover:bg-ink/10</code>; body <code>font-[640]</code>; ink
