...
/**
 * Official Instagram camera glyph, simplified single-path currentColor form.
 * Path data via Simple Icons `icons/instagram.svg` @ develop (CC0; traced
 * from Meta/Instagram brand resources), retrieved 2026-08-05. Nominative use:
 * it identifies the clinic's own official profile; the trademark belongs to
 * its owner.
 *
