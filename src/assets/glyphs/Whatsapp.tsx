...
/**
 * Official WhatsApp speech-bubble glyph, single-path currentColor form.
 * Path data via Simple Icons `icons/whatsapp.svg` @ develop (CC0), retrieved
 * 2026-09-02. Nominative use: it identifies the clinic's own official WhatsApp
 * channel; the trademark belongs to its owner.
 *
