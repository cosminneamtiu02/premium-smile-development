...
// src/lib/not-found-html.ts (every byte of the document),
...
// src/lib/not-found-html.ts' header and restated inside the
...
import {
  renderNotFoundHtml,
  type NotFoundBlock,
} from '../src/lib/not-found-html.ts';
...
src/lib/not-found-html.ts, src/messages/*.json,
